      ...
      <div className="contact-content">
        ...
        <div className="contact-icons">
          <div className="contact-item">
            ...
            <span>
              <strong>Anjali Tomar</strong>
            </span>
          </div>
          <div className="contact-item">
            <FontAwesomeIcon icon={faMapMarkerAlt} className="icon" />
            <span>Arya Nagar, Faridabad, Haryana, India, 121004</span>
          </div>
          <div className="contact-item">
            <FontAwesomeIcon icon={faPhone} className="icon" />
            <span>+91 9693472113</span>
          </div>
          <div className="contact-item">
            <FontAwesomeIcon icon={faEnvelope} className="icon" />
            <span>tomaranjali741@gmail.com</span>
          </div>
          ...
          <div className="contact-item">
            ...
            <span>
              <a
                href="https://www.linkedin.com/in/anjali-tomar-58ab062b8/"
                target="_blank"
